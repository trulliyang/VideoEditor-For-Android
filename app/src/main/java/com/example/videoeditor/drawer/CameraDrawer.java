package com.example.videoeditor.drawer;
...
import com.example.videoeditor.filter.AFilter;
import com.example.videoeditor.gpufilter.SlideGpuFilterGroup;
import com.example.videoeditor.utils.EasyGlUtils;
import com.example.videoeditor.filter.GroupFilter;
import com.example.videoeditor.filter.NoFilter;
import com.example.videoeditor.filter.CameraFilter;
import com.example.videoeditor.filter.ProcessFilter;
import com.example.videoeditor.filter.WaterMarkFilter;
import com.example.videoeditor.gpufilter.filter.MagicBeautyFilter;
import com.example.videoeditor.record.video.TextureMovieEncoder;
import com.example.videoeditor.utils.MatrixUtils;
